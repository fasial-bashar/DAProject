...
class listener(StreamListener):
    ...
    def on_data(self, data):
        ...
        file = open('MUNWBA.csv', 'a')  # Creating a .txt file save data
...
twitterStream.filter(track=["MUNWBA", "ManUtd", "MUFC", "WBA"])    #gathering data that have the given twitter hashatag in it...
