...
class listener(StreamListener):
    ...
    def on_data(self, data):
        ...
        file = open('CRYWAT.csv', 'a')      # Creating a .txt file save data
...
twitterStream.filter(track=["CRYWAT", "Crystal Palace", "Watford"])    #gathering data that have the given twitter hashatag in it...
