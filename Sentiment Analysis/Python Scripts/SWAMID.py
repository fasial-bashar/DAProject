...
class listener(StreamListener):
    ...
    def on_data(self, data):
        ...
        file = open('SWAMID.csv', 'a')  # Creating a .txt file save data
...
twitterStream.filter(track=["SWAMID", "SwansOfficial", "Boro"])    #gathering data that have the given twitter hashatag in it...
