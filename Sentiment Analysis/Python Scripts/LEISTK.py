...
class listener(StreamListener):
    ...
    def on_data(self, data):
        ...
        file = open('LEISTK.csv', 'a')  # Creating a .txt file save data
...
twitterStream.filter(track=["LEISTK", "LCFC", "stokecity"])    #gathering data that have the given twitter hashatag in it...
