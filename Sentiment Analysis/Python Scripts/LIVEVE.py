...
class listener(StreamListener):
    ...
    def on_data(self, data):
        ...
        file = open('LIVEVE.csv', 'a')  # Creating a .txt file save data
...
twitterStream.filter(track=["LIVEVE", "LFC", "Everton", "MerseysideDerby"])    #gathering data that have the given twitter hashatag in it...
