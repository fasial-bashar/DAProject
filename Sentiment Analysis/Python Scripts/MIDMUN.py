...
class listener(StreamListener):
    ...
    def on_data(self, data):
        ...
        file = open('MIDMUN.csv', 'a')  # Creating a .txt file to save data
...
twitterStream.filter(track=["MIDMUN", "ManUtd", "Boro"])    #gathering data that have the given twitter hashatag in it...
