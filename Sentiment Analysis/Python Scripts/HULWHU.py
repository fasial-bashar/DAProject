...
class listener(StreamListener):
    ...
    def on_data(self, data):
        ...
        file = open('HULWHU.csv', 'a')  # Creating a .txt file save data
...
twitterStream.filter(track=["HULWHU", "WestHamUtd", "HullCity"])    #gathering data that have the given twitter hashatag in it...
