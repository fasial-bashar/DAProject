...
class listener(StreamListener):
    ...
    def on_data(self, data):
        ...
        file = open('SUNBUR.csv', 'a')      # Creating a .txt file save data
...
twitterStream.filter(track=["SUNBUR", "Sunderland", "Burnley"])    #gathering data that have the given twitter hashatag in it...
