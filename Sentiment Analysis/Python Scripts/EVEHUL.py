...
class listener(StreamListener):
    ...
    def on_data(self, data):
        ...
        file = open('EVEHUL.csv', 'a')      # Creating a .txt file save data
...
twitterStream.filter(track=["EVEHUL", "Everton", "Hull City"])    #gathering data that have the given twitter hashatag in it...
