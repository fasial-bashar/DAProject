#Reference: https://pythonprogramming.net/use-twitter-api-v1-1-python-stream-tweets/ 
#Reference: https://www.youtube.com/watch?v=pUUxmvvl2FE&t=679s
#importing packages:
...
class listener(StreamListener):
    def on_data(self, data):
        ...
        file = open('MUNCHE.csv', 'a')  # Creating a .csv file save data
...
twitterStream.filter(track=["MUNCHE", "ManUtd", "ChelseaFC"])    #gathering data that have the given twitter hashatag in it...
