...
class listener(StreamListener):
    ...
    def on_data(self, data):
        ...
        file = open('TOTSOU.csv', 'a')  # Creating a .txt file to save data
...
twitterStream.filter(track=["TOTSOU", "COYS","Tottenham Hotspur", "Southampton FC","saintsFC"])    #gathering data that have the given twitter hashatag in it...
