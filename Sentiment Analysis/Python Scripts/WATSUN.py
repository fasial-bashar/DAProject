...
class listener(StreamListener):
    ...
    def on_data(self, data):
        ...
        file = open('WATSUN.csv', 'a')  # Creating a .txt file save data
...
twitterStream.filter(track=["WATSUN", "WatfordFC", "SunderlandAFC"])    #gathering data that have the given twitter hashatag in it...
