...
class listener(StreamListener):
    ...
    def on_data(self, data):
        ...
        file = open('SOUBOU.csv', 'a')  # Creating a .txt file save data
...
twitterStream.filter(track=["SOUBOU", "SouthamptonFC", "SaintsFC", "afcbournemouth", "afcb"])    #gathering data that have the given twitter hashatag in it...
