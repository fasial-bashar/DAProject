...
class listener(StreamListener):
    ...
    def on_data(self, data):
        ...
        file = open('BURTOT.csv', 'a')  # Creating a .txt file save data
...
twitterStream.filter(track=["BURTOT", "SpursOfficial", "COYS", "BurnleyOfficial"])    #gathering data that have the given twitter hashatag in it...
