...
class listener(StreamListener):
    ...
    def on_data(self, data):
        ...
        file = open('ARSMCI.csv', 'a')  # Creating a .txt file save data
...
twitterStream.filter(track=["ARSMCI", "Arsenal", "ManCity", "mcfc"])    #gathering data that have the given twitter hashatag in it...
