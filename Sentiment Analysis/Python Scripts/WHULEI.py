...
class listener(StreamListener):
    ...
    def on_data(self, data):
        ...
        file = open('WHULEI.csv', 'a')      # Creating a .txt file save data
...
twitterStream.filter(track=["WHULEI", "West ham United", "Leicester City"])    #gathering data that have the given twitter hashatag in it...
