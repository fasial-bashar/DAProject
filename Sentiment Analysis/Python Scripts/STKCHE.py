...
class listener(StreamListener):
    ...
    def on_data(self, data):
        ...
        file = open('STKCHE.txt', 'a')  # Creating a .txt file save data
...
twitterStream.filter(track=["STKCHE", "Stoke City", "Chelsea"])    #gathering data that have the given twitter hashatag in it...
