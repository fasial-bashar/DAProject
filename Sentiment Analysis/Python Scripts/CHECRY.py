...
class listener(StreamListener):
    ...
    def on_data(self, data):
        ...
        file = open('CHECRY.csv', 'a')  # Creating a .txt file save data
...
twitterStream.filter(track=["CHECRY", "ChelseaFC", "CPFC"])    #gathering data that have the given twitter hashatag in it...
